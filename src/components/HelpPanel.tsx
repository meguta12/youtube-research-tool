    ...
    <div className="space-y-4 text-sm">
      <section>
        ...
        <ol className="list-decimal pl-5 space-y-1 text-slate-700">
          ...
          <li>気になった動画は、しおりボタンで「ストック」に保存しておけます。</li>
          <li>右上の「Excelダウンロード」で保存できます。</li>
        </ol>
      </section>

      <section>
        <h3 className="font-semibold text-slate-800 mb-1">ストック（動画の保存）</h3>
        <ul className="list-disc pl-5 space-y-1 text-slate-700">
          <li>動画リストの各行・「今アツい動画」カード・サムネ一覧のカードにある<strong>しおりボタン</strong>を押すと、その動画がストックに保存されます。もう一度押すと外れます。</li>
          <li>保存した動画は<strong>検索したキーワードごと</strong>に自動で分類されます。同じ動画でも別のキーワードで見つけて保存すれば、それぞれのグループに入ります。</li>
          <li>「ストック」画面ではキーワードで絞り込み、再生数やヒートスコアで並び替え、1件ずつメモを書けます。表示中のストックはCSVに書き出せます。</li>
          <li>保存されるのはストックした時点の数値（再生数など）です。最新の数値を見たいときは、そのキーワードで再検索してください。</li>
          <li>ストックもブラウザ内にだけ保存されます。設定の「バックアップ」にも含まれます。</li>
        </ul>
      </section>
